...
/*PROTECTED REGION ID(usingPráctica3GenNHibernate.CEN.Práctica3_Producto_decrementarStock) ENABLED START*/
...
{
public void DecrementarStock (int p_producto_oid, int p_decremento)
{
        /*PROTECTED REGION ID(Práctica3GenNHibernate.CEN.Práctica3_Producto_decrementarStock) ENABLED START*/

        ProductoEN productoEN = _IProductoCAD.ReadOID (p_producto_oid);

        if (productoEN.Stock < p_decremento)
