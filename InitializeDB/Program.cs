...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: Práctica3GenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("Práctica3GenNHibernate", "nhibernateUser", "nhibernatePass");
